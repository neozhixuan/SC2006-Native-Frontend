...
const ViewSuggestionsUI = (props: InventoryProps) => {
    ...
    "Ingredients": [{"Name": "Fish", "Quantity": 1}, {"Name": "Burger Bun", "Quantity": 2}, {"Name": "Cheese Slice", "Quantity" : 1}]
    },
    {"id": 1,
    "ItemName": "Fish And Chips", "Ingredients": [{"Name": "Fish Patty", "Quantity": 2}, {"Name": "Potato Fries", "Quantity": 1}]}
    ]);
